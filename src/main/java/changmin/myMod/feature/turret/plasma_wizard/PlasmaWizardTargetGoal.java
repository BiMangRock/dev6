...
public class PlasmaWizardTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    private final PlasmaWizardEntity turret;

    public PlasmaWizardTargetGoal(PlasmaWizardEntity turret, Class<T> targetType) {
